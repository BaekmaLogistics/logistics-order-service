...
public enum ErrorResponseCode implements ApiResponseCode {
    ...
    ORDER_DELIVERY_CANCEL_FAILED(HttpStatus.BAD_GATEWAY, "ORDER_0010", "배송 취소 요청에 실패했습니다."),
    ORDER_STOCK_RESTORE_FAILED(HttpStatus.BAD_GATEWAY, "ORDER_0011", "재고 복구 요청에 실패했습니다."),
    ORDER_DELIVERY_STATUS_LOOKUP_FAILED(HttpStatus.BAD_GATEWAY, "ORDER_0012", "배송 상태 조회에 실패했습니다.");
