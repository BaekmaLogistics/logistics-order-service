...
public enum ErrorResponseCode implements ApiResponseCode {
    ...
    ORDER_DELIVERY_NOT_ASSIGNED(HttpStatus.BAD_REQUEST, "ORDER_0007", "배송이 배정되지 않은 주문입니다."),
    ORDER_ACCESS_DENIED(HttpStatus.FORBIDDEN, "ORDER_0008", "주문에 접근할 권한이 없습니다."),
    ORDER_CANNOT_CHANGE_STATUS(HttpStatus.BAD_REQUEST, "ORDER_0009", "변경할 수 없는 주문 상태입니다."),
    ORDER_DELIVERY_CREATE_FAILED(HttpStatus.BAD_GATEWAY, "ORDER_0010", "배송 생성 요청에 실패했습니다."),
    ORDER_DELIVERY_CANCEL_FAILED(HttpStatus.BAD_GATEWAY, "ORDER_0011", "배송 취소 요청에 실패했습니다."),
